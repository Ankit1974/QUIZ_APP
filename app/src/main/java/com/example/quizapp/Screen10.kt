    ...
    Surface(
        ...
        Column(
            ...
            Column(modifier = Modifier.padding(dimensionResource(R.dimen.padding_medium))) {
                Text(text = "9. Which of the following is a valid syntax to synchronize the HashMap? ")
                    ...
                    Row(
                        modifier = Modifier
                            ...
                            .clickable {
                                ...
                                selectedOption = item
                                viewModel.onOptionSelected(item , 9)
                            }
            ...
            Row(
                ...
                Button(
                    ...
                    onClick = {
                        ...
                        navController.navigate(QuizeScreen.question10.name)
                    }
                ) {
                    Text("Next")
                }
