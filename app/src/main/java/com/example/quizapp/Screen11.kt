    ...
    Surface(
        ...
        Column(
            ...
            Column(modifier = Modifier.padding(dimensionResource(R.dimen.padding_medium))) {
                Text(text = "10. Which of the following is a mutable class in java?")
                    ...
                    Row(
                        modifier = Modifier
                            ...
                            .clickable {
                                ...
                                selectedOption = item
                                viewModel.onOptionSelected(item , 10)
                            }
            ...
            Row(
                ...
                Button(
                    ...
                    onClick = {
                        ...
                        navController.navigate(QuizeScreen.Last.name)
                    }
                ) {
                    Text("Next")
                }
