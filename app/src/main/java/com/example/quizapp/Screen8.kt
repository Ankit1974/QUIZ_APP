    ...
    Surface(
        ...
        Column(
            ...
            Column(modifier = Modifier.padding(dimensionResource(R.dimen.padding_medium))) {
                Text(text = "7. What is meant by the classes and objects that dependents on each other?")
                    ...
                    Row(
                        modifier = Modifier
                            ...
                            .clickable {
                                ...
                                selectedOption = item
                                viewModel.onOptionSelected(item , 7)
                            }
            ...
            Row(
                ...
                Button(
                    ...
                    onClick = {
                        ...
                        navController.navigate(QuizeScreen.question8.name)
                    }
                ) {
                    Text("Next")
                }
