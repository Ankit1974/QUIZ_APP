    ...
    Surface(
        ...
        Column(
            ...
            Column(modifier = Modifier.padding(dimensionResource(R.dimen.padding_medium))) {
                Text(text = "2. Which of the following tool is used to generate API documentation in HTML format from doc comments in source code?")
                    ...
                    Row(
                        modifier = Modifier
                            ...
                            .clickable {
                                ...
                                selectedOption = item
                                viewModel.onOptionSelected(item , 2)
                            }
            ...
            Row(
                ...
                Button(
                    ...
                    onClick = {
                        ...
                        navController.navigate(QuizeScreen.question3.name)
                    }
                ) {
                    Text("Next")
                }
