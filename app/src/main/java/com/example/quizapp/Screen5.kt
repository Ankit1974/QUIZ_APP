    ...
    Surface(
        ...
        Column(
            ...
            Column(modifier = Modifier.padding(dimensionResource(R.dimen.padding_medium))) {
                Text(text = "4.  Which of the following for loop declaration is not valid?")
                    ...
                    Row(
                        modifier = Modifier
                            ...
                            .clickable {
                                ...
                                selectedOption = item
                                viewModel.onOptionSelected(item , 4)
                            }
            ...
            Row(
                ...
                Button(
                    ...
                    onClick = {
                        ...
                        navController.navigate(QuizeScreen.question5.name)
                    }
                ) {
                    Text("Next")
                }
